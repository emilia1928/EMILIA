...
ke = LINETCR.LINE()
ke.login(token="ElhsT5CXERHwUWC3XiN8.bE7ERIfZ64fVKkhSn1IToa.FAnmgyNiT2DUA8X4NukFgHq1T71W2h6+cAd26by3+xk=")

ku = LINETCR.LINE()
ku.login(token="ElA1P4EudTznSjdF7fr2.I7J3VKj7ipRvO+V3fq4MmG.qAgJMJ8hvgnJo1Rep/V/f5z2qYBPUnTmp2e4CQaY85Q=")

kg = LINETCR.LINE()
kg.login(token="Em7juSzLEV8mX50OcRA5.4KqpgMJ1c4lKRUCRLBupPq.URyvvOYn5R0yDrZBiszaBTPrk/hk90DptqyXWl6FTlk=")

kl = LINETCR.LINE()
kl.login(token="EmJJL9pWIlIsnEGxDwzd.dIvTpZHty/FC+WcHwK9qhq.f+eZ057bBys4C6Rv15fEQklb1iM1JCDHubHJC+APuTY=")
...
❕  Notifed
    Notifed on/off
"""
KAC=[cl,ki,kk,kc,ks,kl]
DEF=[ka,kb,ko,ke,ku,kg]
...
def bot(op):
    try:
       ...
       #-----------KICK BY MID-----------####
        ...
        #_______________-_-_-_-INVITE MID----------####
      ...
      #---------------------Kirim Kontak-----------#
                ...
                msg.contentType = 13
                midd = msg.text.replace("Siapa ","")
                cl.findAndAddContactsByMid(midd)
                msg.contentMetadata = {'mid': midd}
                cl.sendMessage(msg.to,[midd])
            elif msg.text in ["Semua"]:
                msg.contentType = 13
            ...
            elif msg.text in ["Open","open","Open url"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
            ...
            elif msg.text in ["Close url","Close"]:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
                    cl.updateGroup(X)
              ...
              if msg.from_ in admin:
                ...
                if wait["autoJoin"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"done")
            elif msg.text in ["Join off","Auto join:off","Join:off"]:
              if msg.from_ in admin:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["Kicker","Kuy join","Bodyguard"]:
              if msg.from_ in admin:
                        G = cl.getGroup(msg.to)
                        ginfo = cl.getGroup(msg.to)
                        G.preventJoinByTicket = False
              ...
              if msg.from_ in admin:
                  ...
                  cl.updateGroup(X)
                  invsend = 0
                  Ti = cl.reissueGroupTicker(msg.to)
                  ka.acceptGroupInvitationByTicket(msg.to,Ti)
                  G = cl.getGroup(msg.to)
                  g.preventJoinByTicket = True
                  cl.updateGroup(G)
                  Ticket = cl.reissueGroupByTicket(msg.to)
    ...
    #-------------Fungsi Tag All Finish---------------#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                          if target not in Bots:
                            try:
                                klist=[ki,kk,kc,ks,ka,ke,ko,ku,kg]
                                kicker=random.choice(klist)
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                ...
                                ks.sendText(msg.to,"Sukses")
                                ka.sendText(msg.to,"Done bl")
                                kb.sendText(msg.to,"Mampus")
                                ko.sendText(msg.to,"Luhh!!")
                                ke.sendText(msg.to,"Gua")
                                ku.sendText(msg.to,"Blacklist dari grup..hahah")
                            except:
                                ki.sendText(msg.to,"Error")
            #----------------Fungsi Banned User Target Finish-----------------------# 
            
            #----------------Fungsi Unbanned User Target Start-----------------------#
            elif "Unbl @" in msg.text:
              if msg.from_ in admin:
                if msg.toType == 2:
                    print "Unbl Sukses"
                    _name = msg.text.replace("Unbl @","")
                    _nametarget = _name.rstrip('  ')
                    gs = cl.getGroup(msg.to)
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
        ...
        #-------------Fungsi Spam Start---------------------#
            	...
            	bctxt = msg.text.replace("Ciduk @ ", "")
                _nametarget = _name.rstrip(' ')
                gs = cl.getGroup(msg.to)
                for g in gs.members:
                    if _nametarget == g.displayName:
                       cl.sendText(msg.to,"Otw..wkwk")
                       ki.sendText(g.mid,(bctxt))
                       cl.sendText(g.mid,(bctxt))
                       kk.sendText(g.mid,(bctxt))
                       kc.sendText(g.mid,(bctxt))
                       ks.sendText(g.mid,(bctxt))
              ...
              if msg.from_ in admin:
                ...
                for g in gs.members:
                    if _nametarget == g.displayName:
                       ...
                       ke.sendText(g.mid,"Awas ledakan  􀜁􀅔Har Har􏿿")
                       ku.sendText(g.mid,"Dorrrrrrrrrrrr  􀜁􀅔Har Har􏿿")
                       ki.sendText(g.mid,"Duarrrrr  􀜁􀅔Har Har􏿿")  
                       kk.sendText(g.mid,"BooM  􀜁􀅔Har Har􏿿")  
                       kc.sendText(g.mid,"Awas ledakan  􀜁􀅔Har Har􏿿")
                       ks.sendText(g.mid,"DorrRRrrR  􀜁􀅔Har Har􏿿")
                       ka.sendText(g.mid,"DorrRrrrR  􀜁􀅔Har Har􏿿")
                       kb.sendText(g.mid,"Dorr  􀜁􀅔Har Har􏿿")
                       ko.sendText(g.mid,"Hahaha  􀜁􀅔Har Har􏿿")
                       ke.sendText(g.mid,"Duarrrrrrrr  􀜁􀅔Har Har􏿿")
                       ku.sendText(g.mid,"Durrrrr  􀜁􀅔Har Har􏿿")
                       ki.sendText(g.mid,"DuarRrrrrrRrRRrr  􀜁􀅔Har Har􏿿")  
                       kk.sendText(g.mid,"Dorrr  􀜁􀅔Har Har􏿿")  
                       kc.sendText(g.mid,"Darrrr  􀜁􀅔Har Har􏿿")
                       ks.sendText(g.mid,"Derrr  􀜁􀅔Har Har􏿿")
                       ka.sendText(g.mid,"Dorrr  􀜁􀅔Har Har􏿿")
                       kb.sendText(g.mid,"Beemmm  􀜁􀅔Har Har􏿿")
                       ko.sendText(g.mid,"Dorrrr  􀜁􀅔Har Har􏿿")
                       ke.sendText(g.mid,"Darrrr  􀜁􀅔Har Har􏿿")
                       ku.sendText(g.mid,"DerRrrRrrRr  􀜁􀅔Har Har􏿿")
                       ki.sendText(g.mid,"Spam  􀜁􀅔Har Har􏿿")  
                       kk.sendText(g.mid,"Spam  􀜁􀅔Har Har􏿿")  
                       kc.sendText(g.mid,"Spam  􀜁􀅔Har Har􏿿")
                       ...
                       ke.sendText(g.mid,"Deerrrrr!!  􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
            ...
            elif msg.text in ["Pekok","pekok"]:
                ki.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                kk.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                kc.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                ks.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                ka.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                kb.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                ko.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                ke.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
                ku.sendText(msg.to,"pekok 􀜁􀅔Har Har􏿿")
...
#-----------------------------------------------
       ...
       #-------------Fungsi Respon Start---------------------#
                ...
                ki.sendText(msg.to,"Ram")
                kk.sendText(msg.to,"Rem")
                kc.sendText(msg.to,"Emilia")
                ks.sendText(msg.to,"Sue Gua blom dikasih nama-_")
                ka.sendText(msg.to,"Sagiri.....")
                ko.sendText(msg.to,"Kanna:v")
                kb.sendText(msg.to,"Yahaha mampus yg belom dikasih nama")
                cl.sendText(msg.to,"Weh gblk lu juga blom gua kasih nama bego")
                kb.sendText(msg.to,"Lahhh...gua kan rem😪😪")
                kk.sendText(msg.to,"Apa bae lu siapa gua Rem..ga usah ngaku ngaku luhh")
                ko.sendText(msg.to,"Udah woii lanjutin absen duh...")
                ku.sendText(msg.to,"-_-")
      ...
      #-------------Fungsi Bannlist Finish------------------#  
                ...
                if msg.toType == 2:
                    ...
                    if matched_list == []:
                        ...
                        kc.sendText(msg.to,"Disini tidak ada user blacklist")
                        return
                    for jj in matched_list:
